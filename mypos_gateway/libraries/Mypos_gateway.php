...
{
    protected $sandbox_url = 'https://www.mypos.eu/vmp/checkout-test';
    protected $production_url = 'https://www.mypos.eu/vmp/checkout';
    ...
    public function finish_payment($post_data)
    {
        ...
        try {
            $responce = Mypos\IPC\Response::getInstance($cnf, $post_data, \Mypos\IPC\Defines::COMMUNICATION_FORMAT_POST);
